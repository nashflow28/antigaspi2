-- Base de données Antigaspi - Schéma corrigé
-- Système de lutte contre le gaspillage alimentaire
-- Compatible avec XAMPP/MySQL 8.0
-- ORDRE CORRECT DES TABLES AVEC DÉPENDANCES
...
-- =====================================
-- TABLE 1: users (Base - pas de dépendances)
-- =====================================
CREATE TABLE users (
...
-- =====================================
-- TABLE 2: categories (Base - pas de dépendances)
-- =====================================
...
-- =====================================
-- TABLE 6: payments (Dépend de reservations)
-- =====================================
...
-- =====================================
-- TABLE 7: reviews (Dépend de users, merchants, products)
-- =====================================
...
-- =====================================
-- TABLE 8: loyalty_points (Dépend de users)
-- =====================================
...
-- =====================================
-- TABLE 9: notifications (Dépend de users)
-- =====================================
...
-- =====================================
-- TABLE 10: analytics_daily (Dépend de merchants)
-- =====================================
...
SELECT CONCAT('Nombre de tables créées: ', COUNT(*)) as INFO
