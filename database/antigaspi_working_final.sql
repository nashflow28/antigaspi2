-- =====================================
-- Base de données Antigaspi - VERSION FINALE FONCTIONNELLE
-- Script testé et validé par l'utilisateur
-- =====================================
...
-- =====================================
-- ÉTAPE 2: CRÉATION DES TABLES (sans FK inline)
-- =====================================
...
('admin@antigaspi.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin', 'System', 'admin', 1);
...
(3, 'Boulangerie Martin', 'Boulangerie', 1),
(4, 'Superette Bella', 'Épicerie', 1);
...
-- =====================================
ALTER TABLE users ADD INDEX idx_email (email), ADD INDEX idx_role (role);
ALTER TABLE categories ADD INDEX idx_name (name);
ALTER TABLE merchants ADD INDEX idx_business_name (business_name);
ALTER TABLE products ADD INDEX idx_merchant (merchant_id), ADD INDEX idx_category (category_id), ADD INDEX idx_active (is_active);
ALTER TABLE reservations ADD INDEX idx_user (user_id), ADD INDEX idx_product (product_id), ADD INDEX idx_status (status), ADD INDEX idx_code (reservation_code);
