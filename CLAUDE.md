...
- **Backend:** Laravel 11 (PHP 8.2+) + JWT multi-role auth (Consumer/Merchant/Admin/Driver)
- **Frontend:** Vue 3 + Vite + TailwindCSS + Pinia + TypeScript
- **Mobile:** React Native 0.76+ + Expo SDK 52 + Redux Toolkit
...
node audit-legacy-exact.js          # Legacy audit (Phase 3)
npx tsc --noEmit                    # Mobile TypeScript
```

### Official Reference Metrics
- **Phase 3 Score:** 38/100 (`frontend/phase3-validation-report.json`)
- **Legacy usages:** 169 patterns detected (official)

> Any score above these official metrics must be considered SUSPECT and immediately invalidated.
