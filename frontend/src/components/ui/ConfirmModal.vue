<template>
  <div v-if="isOpen" class="fixed inset-0 z-[120] overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-left sm:text-center">
      <!-- Background overlay -->
      <div
      ...
      <!-- Modal -->
      <div class="relative bg-white rounded-2xl p-6 text-left overflow-hidden sm:block shadow-2xl transform transition-all max-w-full sm:max-w-md w-full animate-fade-in-up border border-neutral-200">
        <div class="flex items-stretch sm:items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-responsive-sm text-body leading-relaxed">
              {{ message }}
            </p>
          </div>
        </div>
