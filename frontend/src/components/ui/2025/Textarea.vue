...
export type TextareaVariant = 'subtle' | 'filled' | 'transparent'
...
const baseClasses =
  'flex w-full rounded-xl border bg-surface-light px-3 py-3 text-neutral-700 transition-all duration-200 ease-spring-out placeholder:text-neutral-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-300 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-light dark:bg-surface-dark dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus-visible:ring-offset-surface-dark disabled:cursor-not-allowed disabled:opacity-60 resize-y'
