  ...
  <div class="bg-white rounded shadow">
    <div class="p-6 border-b border-neutral-200">
      <div class="flex items-center justify-start sm:justify-between">
        ...
        <button
          :disabled="loading"
          class="p-2 text-neutral-400 hover:text-neutral-700 disabled:opacity-50"
      ...
      <div class="mt-4 flex flex-wrap gap-3">
        <select
          ...
          class="px-3 py-3 border border-neutral-300 rounded text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent"
          @change="applyFilters"
        >
        ...
        <button
          class="px-3 py-3 text-sm text-neutral-700 hover:text-neutral-800"
          @click="clearFilters"
        >
          Effacer filtres
        </button>
    ...
    <div class="divide-y divide-neutral-200">
      <div v-if="loading && !transactions.length" class="p-6">
        <div class="animate-pulse space-y-4">
          <div v-for="i in 3" :key="i" class="flex items-center space-y-4 sm:space-x-4">
            <div class="h-6 w-6 bg-neutral-200 rounded-full" />
      ...
      <div v-else-if="!transactions.length" class="p-6 text-left sm:text-center">
        <div class="text-neutral-500">
          <svg
            class="w-12 h-10 mx-auto mt-3 text-neutral-500"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
