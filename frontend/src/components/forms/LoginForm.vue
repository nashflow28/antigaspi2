<template>
  ...
  <div v-else class="space-y-8">
    ...
    <form class="space-y-6 animate-fade-in-up" style="animation-delay: 0.2s;" @submit.prevent="handleSubmit">
      <!-- Email Input -->
      <div class="space-y-4">
        <label for="email" class="block text-sm font-medium text-neutral-800 mt-2 flex items-center gap-2">
      ...
      <!-- Password Input -->
      <div class="space-y-4">
        <label for="password" class="block text-sm font-medium text-neutral-800 mt-2 flex items-center gap-2">
        ...
        <div class="relative">
          ...
          <button
            type="button"
            class="relative sm:absolute inset-y-0 right-0 pr-4 flex items-center text-neutral-400 hover:transition-colors duration-200"
      ...
      <div class="flex items-center justify-start sm:justify-between">
        <div class="flex items-center gap-2">
          <input
            ...
            type="checkbox"
            class="h-4 w-4 text-primary-600 bg-white border-2 border-neutral-300 rounded focus:ring-primary-500 focus:ring-2"
          >
          <label for="remember-me" class="text-sm text-neutral-800 font-medium">
            Se souvenir de moi
          </label>
        </div>
      ...
      <div class="relative">
        ...
        <div class="relative flex justify-center text-sm">
          <span class="px-3 bg-white text-neutral-500 font-medium">ou</span>
        </div>
      </div>
    ...
    <!-- Footer Links -->
    <div class="text-left sm:text-center text-sm text-neutral-500 animate-fade-in-up" style="animation-delay: 0.4s;">
      <p>
        En vous connectant, vous acceptez nos
        <a href="#" class="text-primary-600 hover:text-primary-900 hover:transition-colors duration-200">
