    ...
    <div class="container p-6">
      ...
      <div class="mt-4 sm:mb-3xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mt-8">
          <Card class="bg-gradient-to-r from-primary-500 via-primary-600 to-primary-700 text-white">
          ...
          <Card class="bg-gradient-to-r from-primary-500 to-accent-blue text-white">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-primary-100 text-sm font-medium">Produits Sauvés</p>
          ...
          <Card class="bg-gradient-to-r from-accent-orange to-primary-600 text-white">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-accent-orange/90 text-sm font-medium">Chiffre d'affaires</p>
                <p class="text-xl font-semibold">{{ formatCurrency(stats.totalRevenue) }}</p>
                <p class="text-accent-orange/80 text-sm mt-1">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-3 sm:gap-6 mt-4 sm:mb-3xl">
        ...
        <Card class="xl:col-span-2">
          ...
          <div class="space-y-4">
            <div
              ...
              :key="activity.id"
              class="flex items-center gap-3 p-4 bg-neutral-50 rounded hover:transition-colors"
            >
        ...
        <Card>
          <template #header>
            <h3 class="text-xl font-semibold text-neutral-900">État du système</h3>
          </template>
          ...
          <!-- Quick Actions -->
          <div class="mt-6 pt-2xl border-t border-neutral-200">
            <h4 class="font-semibold text-neutral-900 mb-4">Actions rapides</h4>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-6 mt-4 sm:mb-3xl">
        ...
        <Card>
          <div class="flex items-center gap-3 mt-3">
            <div class="p-2 bg-primary-100 rounded">
              <GlobeEuropeAfricaIcon class="h-6 w-6 text-primary-600" />
            </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              ...
              <span class="font-semibold text-primary-600">{{ formatNumber(environmentalImpact.co2Saved) }} kg</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-neutral-600">Eau économisée</span>
              <span class="font-semibold text-accent-blue">{{ formatNumber(environmentalImpact.waterSaved) }} L</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-neutral-600">Déchets évités</span>
              <span class="font-semibold text-primary-600">{{ formatNumber(environmentalImpact.wasteSaved) }} kg</span>
            </div>
          </div>
        ...
        <Card>
          <template #header>
            <h3 class="text-lg font-semibold text-neutral-900">Top Commerçants</h3>
          </template>
          ...
          <div class="space-y-2">
            <div
              ...
              :key="merchant.id"
              class="flex items-center gap-3 p-3 bg-neutral-50 rounded"
            >
              <div class="flex-shrink-0">
                <div class="h-6 w-6 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center font-semibold text-sm">
                  {{ index + 1 }}
                </div>
              </div>
              <div class="flex-grow min-w-none">
        ...
        <Card>
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <div class="text-right">
                <div class="w-12 bg-neutral-200 rounded-full h-4">
                  <div
      ...
      <Card v-if="alerts.length > 0" class="mt-4 sm:mb-3xl">
        <template #header>
          <h3 class="text-lg font-semibold text-neutral-900">Alertes et notifications</h3>
        </template>
...
const getActivityIconClass = (type: string): string => {
  const classes: Record<string, string> = {
    ...
    merchant_joined: 'bg-primary-100 text-primary-700',
...
const getAlertClass = (type: string): string => {
  const classes: Record<string, string> = {
    ...
    info: 'bg-primary-50 border-primary-200 text-neutral-800',
    success: 'bg-primary-50 border-primary-200 text-primary-700'
  }
  return classes[type] || 'bg-neutral-50 border-neutral-200 text-neutral-700'
}
