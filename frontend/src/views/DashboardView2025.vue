    ...
    <div class="container px-3 sm:px-4 lg:px-6 py-6 sm:py-8">
      ...
      <div class="grid lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div class="space-y-6">
          ...
          <!-- Tips écologiques -->
          <Card class="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 animate-fade-in-up" style="animation-delay: 0.9s;">
            ...
            <Button size="sm" class="bg-blue-500 text-white hover:bg-blue-600 w-full" @click="nextTip">
              Astuce suivante
            </Button>
          </Card>
        </div>
