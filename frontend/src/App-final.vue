<template>
  <div id="app" class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-dark-900 dark:via-dark-800 dark:to-dark-900 transition-colors duration-500">
    ...
    <div class="fixed inset-0 -z-10 opacity-20 dark:opacity-10">
      <div class="relative sm:absolute inset-0 bg-gradient-to-r from-primary-500/10 via-accent-blue/5 to-accent-blue/15" />
      ...
      <div class="relative sm:absolute top-0 -right-4 w-72 h-72 bg-accent-blue/30 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000" />
      <div class="relative sm:absolute -bottom-8 left-20 w-72 h-72 bg-accent-orange/40 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000" />
    </div>
  </div>
</template>
